...
export const ppStyles: Record<string, CSSProperties> = {
  ...
  optionDecisionTray: {
    ...
    borderLeft: "3px solid rgba(168,32,45,0.86)",
    borderRadius: 4,
    background:
      "linear-gradient(135deg, rgba(42,18,22,0.94), rgba(14,14,18,0.96) 52%, rgba(10,10,12,0.98))",
    boxShadow: "0 18px 42px rgba(0,0,0,0.26), inset 0 1px 0 rgba(255,240,205,0.08)",
    overflow: "hidden",
    boxSizing: "border-box" as const,
  },
  optionDecisionTrayCompact: {
    gridTemplateColumns: "minmax(0, 1fr)",
    padding: "12px",
    rowGap: 11,
  },
  optionDecisionHeader: {
    gridColumn: "1 / -1",
    minWidth: 0,
    display: "flex",
    alignItems: "center",
  ...
  optionCommitRail: {
    ...
    rowGap: 12,
    paddingLeft: 14,
    borderLeft: "1px solid rgba(245,200,120,0.16)",
  },
  optionCommitRailCompact: {
    paddingLeft: 0,
    borderLeft: "none",
