...
export const ppStyles: Record<string, CSSProperties> = {
  ...
  optionCardConfirmPanel: {
    ...
    borderLeft: "2px solid rgba(245,200,120,0.42)",
    borderBottom: "1px solid rgba(245,200,120,0.18)",
    background: "linear-gradient(90deg, rgba(120,31,38,0.18), rgba(12,12,16,0.08) 58%, transparent)",
    display: "flex",
    flexDirection: "column" as const,
    gap: 8,
  },
  ...
  optionCardConfirmRail: {
    minWidth: 0,
    display: "grid",
    gridTemplateColumns: "minmax(220px, 0.72fr) minmax(0, 1fr)",
    alignItems: "center",
    columnGap: 14,
    rowGap: 9,
  },
  ...
  optionPrimaryCommitButton: {
    ...
    padding: "10px 14px",
    borderRadius: 3,
    border: "1px solid rgba(245,200,120,0.64)",
    borderTop: "2px solid rgba(255,226,168,0.82)",
    background: "linear-gradient(180deg, rgba(146,33,43,0.96), rgba(86,22,29,0.98))",
    boxShadow: "0 12px 30px rgba(0,0,0,0.28), inset 0 1px 0 rgba(255,238,198,0.20)",
  ...
  optionPrimaryCommitButtonDisabled: {
    color: "rgba(232,218,205,0.48)",
    borderColor: "rgba(245,200,120,0.22)",
    background: "rgba(48,34,36,0.72)",
    boxShadow: "none",
    cursor: "default",
  },
  ...
  optionExpandCue: {
    ...
    lineHeight: 1.25,
    fontWeight: 760,
    borderBottom: "1px solid rgba(246,221,176,0.16)",
    whiteSpace: "nowrap" as const,
  },
  optionExpandCueActive: {
    color: "rgba(245,200,120,0.82)",
    borderBottomColor: "rgba(245,200,120,0.32)",
  },
