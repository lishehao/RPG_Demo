...
export const ppStyles: Record<string, CSSProperties> = {
  ...
  optionBtn: {
    ...
    background: "linear-gradient(180deg, rgba(8,22,34,0.62), rgba(5,12,22,0.58))",
    borderTopWidth: 1,
    borderTopStyle: "solid",
    borderTopColor: "rgba(107,226,236,0.08)",
    borderRightWidth: 1,
    borderRightStyle: "solid",
    borderRightColor: "rgba(107,226,236,0.07)",
    borderBottomWidth: 1,
    borderBottomStyle: "solid",
    borderBottomColor: "rgba(107,226,236,0.10)",
    borderLeftWidth: 1,
    borderLeftStyle: "solid",
    borderLeftColor: "rgba(107,226,236,0.16)",
    borderRadius: 6,
    color: "var(--text)",
    cursor: "pointer",
    ...
    fontFamily: "inherit",
    outline: "none",
    boxShadow: "inset 0 1px 0 rgba(210,250,255,0.035)",
    WebkitTapHighlightColor: "rgba(82,228,238,0.13)",
  },
  optionBtnCompact: {
    minHeight: 74,
  ...
  optionBtnSelected: {
    background: "linear-gradient(160deg, rgba(7,48,66,0.94), rgba(5,16,31,0.98) 64%, rgba(3,9,18,0.96))",
    color: "rgba(234,252,255,0.98)",
    borderTopColor: "rgba(102,241,247,0.46)",
    borderRightColor: "rgba(65,219,231,0.25)",
    borderBottomColor: "rgba(66,224,234,0.30)",
    borderLeftColor: "rgba(75,238,246,0.78)",
    boxShadow: "0 16px 42px rgba(0,13,27,0.30), 0 0 0 1px rgba(77,232,242,0.10), inset 0 1px 0 rgba(218,255,255,0.12)",
  },
  optionBtnExpanded: {
    color: "rgba(238,253,255,0.98)",
  },
  optionBtnDeemphasized: {
    background: "linear-gradient(180deg, rgba(7,18,30,0.42), rgba(4,10,18,0.38))",
    boxShadow: "none",
    borderTopColor: "rgba(107,226,236,0.04)",
    borderRightColor: "rgba(107,226,236,0.04)",
    borderBottomColor: "rgba(107,226,236,0.06)",
    borderLeftColor: "rgba(107,226,236,0.08)",
  },
  optionBtnPicked: {
    background: "linear-gradient(160deg, rgba(8,54,72,0.95), rgba(5,16,31,0.98))",
    color: "rgba(238,253,255,0.98)",
    borderTopColor: "rgba(102,241,247,0.50)",
    borderRightColor: "rgba(65,219,231,0.26)",
    borderBottomColor: "rgba(66,224,234,0.34)",
    borderLeftColor: "rgba(75,238,246,0.86)",
    boxShadow: "0 16px 42px rgba(0,13,27,0.30), 0 0 0 1px rgba(77,232,242,0.12), inset 0 1px 0 rgba(218,255,255,0.14)",
  },
  optionCardConfirmPanel: {
    marginTop: -2,
    marginBottom: 13,
    padding: "10px 11px 12px",
    borderLeft: "1px solid rgba(67,222,234,0.34)",
    borderRight: "1px solid rgba(67,222,234,0.10)",
    borderBottom: "1px solid rgba(67,222,234,0.20)",
    borderRadius: "0 0 6px 6px",
    background: "linear-gradient(135deg, rgba(6,38,54,0.62), rgba(4,14,27,0.24) 62%, transparent)",
    boxShadow: "0 14px 34px rgba(0,10,22,0.18)",
    display: "flex",
    flexDirection: "column" as const,
    gap: 8,
  },
  ...
  optionPrimaryCommitButton: {
    ...
    borderTopWidth: 1,
    borderTopStyle: "solid",
    borderTopColor: "rgba(210,255,255,0.55)",
    borderRightWidth: 1,
    borderRightStyle: "solid",
    borderRightColor: "rgba(95,238,246,0.44)",
    borderBottomWidth: 1,
    borderBottomStyle: "solid",
    borderBottomColor: "rgba(95,238,246,0.44)",
    borderLeftWidth: 1,
    borderLeftStyle: "solid",
    borderLeftColor: "rgba(95,238,246,0.44)",
    background: "linear-gradient(180deg, rgba(20,117,130,0.96), rgba(8,74,91,0.98))",
    boxShadow: "0 14px 30px rgba(20,184,200,0.14), inset 0 1px 0 rgba(214,255,255,0.20)",
    color: "rgba(242,254,255,0.98)",
    fontFamily: "inherit",
    fontSize: 14,
    lineHeight: 1.2,
    fontWeight: 900,
  ...
  optionPrimaryCommitButtonDisabled: {
    color: "rgba(197,232,236,0.54)",
    borderTopColor: "rgba(92,210,220,0.20)",
    borderRightColor: "rgba(92,210,220,0.18)",
    borderBottomColor: "rgba(92,210,220,0.18)",
    borderLeftColor: "rgba(92,210,220,0.18)",
    background: "linear-gradient(180deg, rgba(14,54,67,0.70), rgba(8,26,38,0.76))",
    boxShadow: "0 10px 26px rgba(0,10,22,0.14), inset 0 1px 0 rgba(214,255,255,0.06)",
    cursor: "default",
  },
  ...
  optionExpandCue: {
    marginLeft: "auto",
    color: "rgba(143,229,237,0.56)",
    fontSize: 11.5,
    lineHeight: 1.25,
    fontWeight: 760,
    borderBottomWidth: 1,
    borderBottomStyle: "solid",
    borderBottomColor: "rgba(90,225,235,0.16)",
    whiteSpace: "nowrap" as const,
  },
  optionExpandCueActive: {
    color: "rgba(119,244,250,0.88)",
    borderBottomColor: "rgba(119,244,250,0.34)",
  },
  optionExpandedDetail: {
    ...
    marginTop: 6,
    paddingTop: 8,
    borderTop: "1px solid rgba(107,226,236,0.16)",
  },
