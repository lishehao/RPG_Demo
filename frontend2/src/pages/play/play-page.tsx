...
const ppStyles: Record<string, CSSProperties> = {
  ...
  runtimeInspector: {
    ...
    background:
      "linear-gradient(135deg, rgba(154,148,200,0.10), rgba(255,255,255,0.026) 46%, rgba(0,0,0,0.16))",
    border: "1px solid rgba(154,148,200,0.24)",
    borderRadius: 3,
  ...
  advisorPanel: {
    ...
    background:
      "linear-gradient(160deg, rgba(255,255,255,0.055), rgba(255,255,255,0) 42%), linear-gradient(180deg, rgba(21,17,13,0.98), rgba(8,7,6,0.98))",
    backdropFilter: "none",
    WebkitBackdropFilter: "none",
    borderLeft: "1px solid rgba(236,204,152,0.16)",
    display: "flex",
    flexDirection: "column",
    zIndex: 31,
  ...
  advisorPanelCompact: {
    ...
    background:
      "linear-gradient(180deg, rgba(21,17,13,0.99), rgba(8,7,6,0.99))",
  ...
  advisorHeaderCompact: {
    ...
    borderBottom: "1px solid rgba(236,204,152,0.08)",
    gap: 8,
  },
  advisorHeaderAvatar: {
    width: 30,
