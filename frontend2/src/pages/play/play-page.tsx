...
import {
  ...
  buildIntentReadReceipt,
  buildOutcomeReceiptItems,
  buildSceneClocks,
  computeBeatIntensity,
  computeLiveInventory,
  findActionTarget,
  isBackgroundStakeholder,
  isScaffoldPartyDisplayName,
  leverageCardId,
  leveragePlayInput,
  outcomePriority,
  parseOptionLabel,
...
const ppStyles: Record<string, CSSProperties> = {
  ...
  progressTrack: {
    height: 3,
    background: "rgba(236,204,152,0.12)",
    position: "relative",
  },
  progressFill: {
    height: "100%",
  ...
  backBtnCompact: {
    width: "auto",
    padding: "0 0 3px",
    borderBottom: "1px solid rgba(236,204,152,0.20)",
    color: "var(--text-muted)",
  ...
  runContextObjectiveLine: {
    ...
    gap: 3,
    paddingLeft: 12,
    borderLeft: "2px solid rgba(154,148,200,0.34)",
  },
  ...
  runInventoryMoreButton: {
    ...
    padding: 0,
    border: "none",
    borderBottom: "1px dotted rgba(208,138,79,0.34)",
    borderRadius: 0,
    background: "transparent",
    color: "var(--text-muted)",
    font: "inherit",
  ...
  runProgressTrack: {
    ...
    maxWidth: 680,
    height: 2,
    background: "rgba(236,204,152,0.14)",
    overflow: "hidden",
  },
  runProgressFill: {
    ...
    inset: "0 auto 0 0",
    display: "block",
    background: "rgba(208,138,79,0.76)",
  },
  runPrivateSummary: {
    marginTop: 9,
    paddingTop: 0,
  ...
  runCastName: { fontSize: 12, color: "var(--text)", fontWeight: 600 },
  runCastRole: { fontSize: 10, color: "var(--text-faint)", marginTop: 1 },
  runtimeInspector: {
    margin: "0 0 24px",
  ...
  runtimeInspectorDetails: {
    marginTop: 12,
    paddingTop: 8,
    borderTop: "1px solid rgba(154,148,200,0.18)",
  },
  runtimeInspectorDetailsSummary: {
    ...
    fontWeight: 680,
    outline: "none",
    WebkitTapHighlightColor: "rgba(154,148,200,0.16)",
  },
  ...
  agentTraceDetails: {
    marginTop: 10,
    paddingTop: 8,
    borderTop: "1px solid rgba(154,148,200,0.24)",
  },
  ...
  agentTraceRow: {
    ...
    paddingBottom: 5,
    paddingLeft: 0,
    borderBottom: "1px solid rgba(154,148,200,0.10)",
  },
  agentTraceValue: {
    minWidth: 0,
    maxWidth: 440,
  ...
  outcomeReceiptChipSafe: {
    color: "rgba(71,110,75,0.92)",
  },
  outcomeReceiptChipTense: {
    color: "rgba(208,138,79,0.9)",
  },
  ...
  pulseImpactInline: {
    marginTop: 8,
    paddingTop: 6,
    borderTop: "1px dashed rgba(76,53,29,0.16)",
    display: "flex",
    alignItems: "baseline",
    columnGap: 10,
    rowGap: 4,
  ...
  pulseShift_warmer: { color: "rgba(68,116,73,0.88)" },
  pulseShift_colder: { color: "rgba(68,83,126,0.88)" },
  pulseShift_wary: { color: "rgba(142,92,24,0.9)" },
  pulseShift_broken: { color: "rgba(169,73,63,0.94)" },
  pulseShift_steady: {},
  ...
  narratorBeat: {
    ...
    background: "rgba(255,255,255,0.035)",
    border: "1px solid rgba(236,204,152,0.14)",
    borderLeft: "2px solid rgba(236,204,152,0.22)",
    borderRadius: 3,
    boxShadow: "none",
  },
  narratorBeatLatest: {
  ...
  beatDecorRising: {
    width: 36,
    height: 1,
    background: "rgba(93,95,143,0.55)",
    marginBottom: 12,
  },
  beatDecorPeak: {
    width: 56,
  ...
  playerBeat: {
    ...
    border: "1px solid rgba(236,204,152,0.12)",
    borderRadius: 3,
  ...
  mobileActionJump: {
    ...
    borderRight: 0,
    borderLeft: 0,
    borderBottom: "1px solid rgba(208,138,79,0.30)",
    background: "transparent",
  ...
  leverageSummaryButtonOpen: {
    color: "var(--text)",
    background: "rgba(208,138,79,0.10)",
    borderLeftColor: "rgba(208,138,79,0.58)",
  },
  ...
  leverageRevealPanel: {
    ...
    padding: "12px 0 0",
    border: "none",
    borderTop: "1px dashed rgba(157,91,47,0.24)",
    borderRadius: 0,
    background: "transparent",
    boxShadow: "none",
    overflow: "hidden",
  ...
  advisorInlineAction: {
    ...
    borderLeft: "none",
    borderRadius: 0,
    borderBottom: "1px solid rgba(208,138,79,0.34)",
    background: "transparent",
    color: "rgba(245,205,150,0.88)",
    display: "inline-flex",
    alignItems: "center",
    fontSize: 12.5,
    fontWeight: 800,
  ...
  optionBtn: {
    ...
    borderTopColor: "rgba(236,204,152,0.12)",
    borderRightWidth: 1,
    borderRightStyle: "solid",
    borderRightColor: "rgba(236,204,152,0.10)",
    borderBottomWidth: 1,
    borderBottomStyle: "solid",
    borderBottomColor: "rgba(236,204,152,0.16)",
    borderLeftWidth: 3,
    borderLeftStyle: "solid",
    borderLeftColor: "rgba(208,138,79,0.30)",
    borderRadius: 3,
    ...
    fontFamily: "inherit",
    outline: "none",
    WebkitTapHighlightColor: "rgba(208,138,79,0.14)",
  },
  optionBtnCompact: {
    minHeight: 76,
  ...
  optionBtnSelected: {
    ...
    color: "var(--text)",
    borderLeftColor: "rgba(208,138,79,0.82)",
    borderTopColor: "rgba(208,138,79,0.22)",
    borderRightColor: "rgba(208,138,79,0.18)",
    borderBottomColor: "rgba(208,138,79,0.28)",
  },
  optionBtnExpanded: {
    color: "var(--text)",
  },
  optionBtnDeemphasized: {
    ...
    boxShadow: "none",
    color: "var(--text-faint)",
    borderLeftColor: "rgba(208,138,79,0.12)",
  },
  optionBtnPicked: {
    background: "rgba(208,138,79,0.16)",
    color: "var(--text)",
    borderLeftColor: "rgba(208,138,79,0.86)",
    borderBottomColor: "rgba(208,138,79,0.28)",
  },
  optionConfirmPanel: {
    marginTop: -1,
  ...
  errorInlineText: { minWidth: 0, color: "rgba(102,53,43,0.82)", lineHeight: 1.4 },
  errorInlineSignal: {
    minWidth: 0,
    color: "rgba(102,53,43,0.66)",
    fontSize: 11.5,
    lineHeight: 1.35,
  },
  errorInlineSignalLabel: {
    marginRight: 6,
    color: "rgba(169,73,63,0.78)",
    fontWeight: 720,
    letterSpacing: 0,
    textTransform: "none" as const,
  },
  ...
  errorInlineChip: {
    ...
    borderRadius: 0,
    border: "none",
    borderBottom: "1px solid rgba(169,73,63,0.2)",
    background: "transparent",
    color: "rgba(102,53,43,0.82)",
    fontSize: 11,
    lineHeight: 1.2,
    overflow: "hidden",
    textOverflow: "ellipsis",
  ...
  fab: {
    ...
    height: 34,
    background:
      "linear-gradient(135deg, rgba(208,138,79,0.14), rgba(255,255,255,0.035) 48%, rgba(0,0,0,0.18))",
    color: "var(--text)",
  ...
  fabLabel: {
    color: "rgba(255,226,178,0.90)",
    fontSize: 13,
    lineHeight: 1.2,
    fontWeight: 800,
    borderBottom: "1px solid rgba(245,200,120,0.30)",
    paddingBottom: 3,
    whiteSpace: "nowrap" as const,
  },
  fabAvatarImg: {
    ...
    borderRadius: "50%",
    objectFit: "cover",
    border: "1px solid rgba(236,204,152,0.22)",
    boxShadow: "none",
    flexShrink: 0,
  },
  advisorBackdrop: {
    ...
    inset: 0,
    background:
      "linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.22) 54%, rgba(0,0,0,0.56) 100%)",
    zIndex: 30,
  },
  ...
  advisorPanel: {
    ...
    background:
      "linear-gradient(145deg, rgba(208,138,79,0.10), rgba(255,255,255,0.045) 28%, rgba(255,255,255,0) 50%), linear-gradient(180deg, rgba(22,18,14,0.99), rgba(8,7,6,0.99))",
    backdropFilter: "none",
    WebkitBackdropFilter: "none",
    borderLeft: "1px solid rgba(236,204,152,0.22)",
    display: "flex",
    flexDirection: "column",
    zIndex: 31,
    boxShadow: "-22px 0 66px rgba(0,0,0,0.42)",
    overflow: "hidden",
  },
  advisorPanelCompact: {
    top: "auto",
    ...
    background:
      "linear-gradient(180deg, rgba(27,21,16,0.99), rgba(8,7,6,0.99))",
  ...
  advisorContextLine: {
    ...
    paddingBottom: 8,
    paddingLeft: 10,
    borderLeft: "2px solid rgba(208,138,79,0.42)",
    background: "linear-gradient(90deg, rgba(208,138,79,0.08), rgba(255,255,255,0))",
  },
  ...
  advisorInput: {
    ...
    paddingLeft: 42,
    borderTop: "1px solid rgba(236,204,152,0.12)",
    background: "linear-gradient(180deg, rgba(255,255,255,0.020), rgba(0,0,0,0.12))",
    display: "flex",
    flexDirection: "column" as const,
    gap: 10,
    alignItems: "stretch",
  ...
  advisorTextarea: {
    ...
    borderRight: "none",
    borderLeft: "none",
    borderBottom: "1px solid rgba(236,204,152,0.26)",
    borderRadius: 0,
    fontSize: 14,
    lineHeight: 1.5,
    color: "var(--text)",
