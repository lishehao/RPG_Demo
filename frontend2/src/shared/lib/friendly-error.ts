...
const ERROR_CODE_FALLBACKS_ZH: Record<string, string> = {
  ...
  llm_unavailable: "这个 beta 动作需要现场 AI 服务。先用 Story Brief 规划生成，或换一个可靠演示路径继续。",
...
const ERROR_CODE_FALLBACKS_EN: Record<string, string> = {
  ...
  llm_unavailable: "This beta action needs live AI service. Plan with a Story Brief first, or continue from a reliable demo route.",
