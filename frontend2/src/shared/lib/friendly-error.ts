...
const ERROR_CODE_FALLBACKS_ZH: Record<string, string> = {
  ...
  agent_trace_forbidden: "Agent Trace 只对已授权 reviewer/admin session 开放。",
...
const ERROR_CODE_FALLBACKS_EN: Record<string, string> = {
  ...
  agent_trace_forbidden: "Agent Trace is only available to authorized reviewer/admin sessions.",
