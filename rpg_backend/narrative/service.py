    ...
    def create_template(
        ...
        *,
        ...
        if request.story_brief is not None and _story_brief_prefers_reliable_opening(request.story_brief):
            opening = render_reliable_opening(request.story_brief, language=request.language)
        else:
            try:
        ...
        if request.story_brief is not None:
            ...
            if story_brief_consistency.status == "fail":
                fallback_opening = render_reliable_opening(request.story_brief, language=request.language)
